...
export function buildConvertedNode(
  ...
  switch (targetId) {
    case "paragraph":
      return schema.nodes.paragraph.create(null, inline || textNode);
    case "h1":
    case "h2":
    case "h3":
    case "h4":
    ...
    case "h6": {
      ...
      return schema.nodes.heading.create({ level }, inline || textNode);
    }
    case "bullet_list":
    case "ordered_list":
    case "task_list": {
      ...
      const para = schema.nodes.paragraph.create(null, inline || textNode);
